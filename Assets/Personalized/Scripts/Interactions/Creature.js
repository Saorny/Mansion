...
{
	public enum STATE { IDLE, WALKING, EATING, ATTACKING, SUFFERING, DYING }
	...
	{
		if (this._state == Creature.STATE.WALKING && this._target != Vector3.zero && this.getRemainingDistanceFromTarget(this._target) < this._range)
		{
